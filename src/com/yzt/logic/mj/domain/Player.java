...
public class Player extends User {
	...
	private Integer mGangScore;// 本局杠分：普通明杠分
	private Integer aGangScore;// 本局杠分：普通暗杠分
	...
	public void setmGangScore(Integer mGangScore) {
		this.mGangScore = mGangScore;
	}
	...
	public void setaGangScore(Integer aGangScore) {
		this.aGangScore = aGangScore;
	}
